...
namespace FleaMarket.Migrations
{
    ...
    [Migration("20230823184044_AddedCountSimilarFavourite2")]
    partial class AddedCountSimilarFavourite2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FleaMarket.Data.AnnouncementsUsers", b =>
                {
            ...
            modelBuilder.Entity("FleaMarket.Data.AnnouncementsUsers", b =>
                {
                    b.HasOne("FleaMarket.Models.AnnouncementModel", "Announcement")
                        .WithMany("Users")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FleaMarket.Authoriz.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
